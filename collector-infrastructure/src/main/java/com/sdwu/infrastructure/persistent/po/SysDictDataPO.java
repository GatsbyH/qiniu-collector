...
public class SysDictDataPO extends BaseDO
{
    ...
    /** 字典编码 */
    @TableId(value = "dict_code", type = IdType.AUTO) // 主键策略
    ...
    public static SysDictData convertToDomain(SysDictDataPO sysDictDataPO) {
        SysDictData sysDictData = new SysDictData();
        BeanUtils.copyProperties(sysDictDataPO, sysDictData);
        return sysDictData;
    }
}
